defmodule Histoire.Nyaa.RateLimiter do
  @moduledoc "Serializes Nyaa requests through a configurable source-wide gate."
  ...
  def handle_call(:reserve, from, %{next_at: next_at} = state) do
    ...
    interval = Application.get_env(:histoire, :nyaa_request_interval_ms, @default_interval_ms)
