defmodule Histoire.Catalog.SubsPleaseTVDBShowMatch do
  ...
  oban do
    ...
    triggers do
      trigger :match_tvdb do
        ...
        worker_module_name Histoire.Catalog.Workers.MatchTVDB
        scheduler_module_name Histoire.Catalog.Schedulers.MatchTVDB
      end
    end
  end
  ...
  actions do
    ...
    update :set_tvdb do
      ...
      change Histoire.Catalog.Changes.FinalizeMatch
    end

    update :accept_candidate do
      require_atomic? false
      accept []
      change Histoire.Catalog.Changes.AcceptCandidate
    end

    update :retry_match do
      require_atomic? false
      accept []
      change Histoire.Catalog.Changes.RetryMatch
    end
    ...
    update :run_tvdb_match do
      ...
      require_atomic? false
      accept []
      change Histoire.Catalog.Changes.RunTVDBMatch
    end
    ...
    update :record_match_failure do
      ...
      change Histoire.Catalog.Changes.RecordMatchFailure
    end
  ...
  relationships do
    belongs_to :subsplease_show, Histoire.SubsPlease.Show do
    ...
    belongs_to :tvdb_series, Histoire.TVDB.Series do
    ...
    belongs_to :tvdb_movie, Histoire.TVDB.Movie do
      source_attribute :tvdb_id
      destination_attribute :id
      define_attribute? false
