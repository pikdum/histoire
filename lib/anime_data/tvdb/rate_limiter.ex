defmodule AnimeData.TVDB.RateLimiter do
  @moduledoc "Serializes TVDB requests through a configurable source-wide gate."
  ...
  def handle_call(:reserve, from, %{next_at: next_at} = state) do
    ...
    interval = Application.get_env(:anime_data, :tvdb_request_interval_ms, @default_interval_ms)
