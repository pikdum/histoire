defmodule Histoire.TVDB.WebSearchTest do
  use ExUnit.Case, async: false

  alias Histoire.TVDB.WebSearch

  setup do
    previous_key = Application.get_env(:histoire, :brave_search_api_key)
    Application.delete_env(:histoire, :brave_search_api_key)

    on_exit(fn ->
      if is_nil(previous_key) do
        Application.delete_env(:histoire, :brave_search_api_key)
      else
        Application.put_env(:histoire, :brave_search_api_key, previous_key)
      end
    end)
  end
